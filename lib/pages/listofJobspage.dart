import 'package:epasos/employerpages/employeer_detail_page.dart';
import 'package:epasos/models/job.dart';
import 'package:flutter/material.dart';

class ListOfJobsPage extends StatefulWidget {
  @override
  _ListOfJobsPageState createState() => _ListOfJobsPageState();
}

class _ListOfJobsPageState extends State<ListOfJobsPage> {
  List<Job> jobs = [
    Job(
      company: "Facebook",
      jobType: "Full Time",
