...
class EmployerManageJob extends StatefulWidget {
  @override
  _EmployerManageJobState createState() => _EmployerManageJobState();
}

class _EmployerManageJobState extends State<EmployerManageJob> {
  List<Job> jobs = [
    Job(
      company: "Facebook",
      jobType: "Full Time",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // drawer: Drawer(),
      appBar: AppBar(
        title: Center(child: Text("Manage Jobs       ")),
